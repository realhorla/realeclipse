...
const AI_MODELS = {
  ...
  'gpt4o': { endpoint: '/chatgpt', param: 'prompt', name: 'GPT-4o', description: 'Latest GPT-4o with multimodal support' },
  'gpt4omini': { endpoint: '/chatgpt', param: 'prompt', name: 'GPT-4o Mini', description: 'Fast GPT-4o - Quick responses' },
  'o1': { endpoint: '/chatgpt', param: 'prompt', name: 'O1', description: 'Advanced reasoning - Logic and problem solving' },
  'o1mini': { endpoint: '/chatgpt', param: 'prompt', name: 'O1 Mini', description: 'Fast reasoning model' },
  'o3mini': { endpoint: '/chatgpt', param: 'prompt', name: 'O3 Mini', description: 'Advanced reasoning in compact size' },
  'o4mini': { endpoint: '/chatgpt', param: 'prompt', name: 'O4 Mini', description: 'Newest reasoning capabilities' },
  'o3': { endpoint: '/chatgpt', param: 'prompt', name: 'O3', description: 'Most powerful O3 - Top-tier reasoning' },
  'chatgpt4o': { endpoint: '/chatgpt', param: 'prompt', name: 'ChatGPT-4o Latest', description: 'Most up-to-date ChatGPT' },
  'gpt4': { endpoint: '/chatgpt', param: 'prompt', name: 'GPT-4', description: 'Standard GPT-4 - Reliable and proven' },
  'gpt4turbo': { endpoint: '/chatgpt', param: 'prompt', name: 'GPT-4 Turbo', description: 'Fast GPT-4 turbo responses' },
  'gpt35turbo': { endpoint: '/chatgpt', param: 'prompt', name: 'GPT-3.5 Turbo', description: 'Fast and cost-effective' },
  'gpt5nano': { endpoint: '/chatgpt', param: 'prompt', name: 'GPT-5 Nano', description: 'Latest GPT-5 Nano model' },
  'gpt5': { endpoint: '/chatgpt', param: 'prompt', name: 'GPT-5', description: 'Advanced GPT-5 AI model' },
  'gemini': { endpoint: '/chatgpt', param: 'prompt', name: 'Google Gemini', description: 'Google\'s Gemini AI model' },
  'deepseek': { endpoint: '/chatgpt', param: 'prompt', name: 'DeepSeek', description: 'DeepSeek AI model' },
  'claude': { endpoint: '/chatgpt', param: 'prompt', name: 'Claude AI', description: 'Anthropic\'s Claude AI model' },
  'grok': { endpoint: '/chatgpt', param: 'prompt', name: 'Grok AI', description: 'xAI\'s Grok model' },
  'metaai': { endpoint: '/chatgpt', param: 'prompt', name: 'Meta AI', description: 'Meta\'s AI model' },
  'qwen': { endpoint: '/chatgpt', param: 'prompt', name: 'Qwen AI', description: 'Alibaba\'s Qwen model' },
  'copilot': { endpoint: '/chatgpt', param: 'prompt', name: 'Microsoft Copilot', description: 'Microsoft Copilot AI' },
  'copilotthink': { endpoint: '/chatgpt', param: 'prompt', name: 'Copilot Think Deeper', description: 'Deep thinking mode for complex reasoning' },
...
async function generateImage(modelKey, prompt, options = {}) {
  ...
  try {
    let url = `${BASE_URL}${model.endpoint}`;
    const params = { prompt };
    ...
    if (options.isNew) params.isNew = options.isNew;
